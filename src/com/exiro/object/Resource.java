...
public enum Resource {
    ...
    MARBLE("Marbre", 1, true, false, 4, 0, List.of()),
    GRAPE("Raisin", 1, true, false, 4, 0, List.of(ObjectType.WINERY)),
    OLIVE("Olive", 1, true, false, 4, 0, List.of(ObjectType.OLIVE_PRESS)),
    WOOL("Laine", 1, true, false, 4, 100, null),
    ARMEMENT("Armement", 1, true, false, 4, 100, List.of()),
