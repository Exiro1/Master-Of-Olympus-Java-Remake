...
public enum FreeState {
    ONLY_ACTIVE_ROAD(0b1), ALL_ROAD(0b11), BLOCKING_ROAD(0b10), BUILDABLE(0b000100), NON_BLOCKING(0b1001), BLOCKED(0b00000), BUILDABLE_ROAD(0b10000), WALKABLE(0b111111), MEADOW(0b100000);
